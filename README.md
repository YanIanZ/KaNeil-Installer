...
![Test Panel](https://github.com/YanIanZ/KaNeil-Script/actions/workflows/panel.yml/badge.svg)
![Test Wings](https://github.com/YanIanZ/KaNeil-Script/actions/workflows/wings.yml/badge.svg)
![Shellcheck](https://github.com/YanIanZ/KaNeil-Script/actions/workflows/shellcheck.yml/badge.svg)
[![License: GPL v3](https://img.shields.io/github/license/YanIanZ/KaNeil-Script)](LICENSE)
...
Unofficial scripts for installing KaNeil Panel & Wings. Works with the latest version of KaNeil!
...
- Automatic installation of the KaNeil Wings (Docker, systemd).
...
```bash
bash <(curl -s https://raw.githubusercontent.com/YanIanZ/KaNeil-Script/main/install.sh)
```
